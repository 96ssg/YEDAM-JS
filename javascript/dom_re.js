...
//html 페이지에 element, attribute, value 을 생성. 수정. 삭제./
...
function addBtnFnc() { //추가버튼 콜백함수.
    ...
    if (name == '' || age == '' || score == '') {
        alert('필수값을 입력하세요.')
        return; // function내에서 return은 function의 종료를 뜻함.
    }
...
table.setAttribute('border', '1'); // 태그에 속성을 추가하는 setAttribute
