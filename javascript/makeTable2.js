...
console.log(`두번째 멤버의 수학점수 : ${members[1].math_score+members[1].first_name+members[1].last_name}`);
console.log(`세번째 멤버의 이름과 성씨 : ${members[2].first_name+members[2].last_name}`);// .last_name == ['last_name']
